...
export const ReportBuyForm = () => {
    ...
    return (
        <form onSubmit={onSubmit}>
            <Stack className={s.stackWrapper}>
                <TextInput {...emailProps} classNames={s} />
                ...
                <Text fz={12} ta='center' mb={12}>
                    Нажимая на кнопку, вы подтверждаете свое согласие на сбор, хранение и использование ваших
